...
<main class="ls-main ">
    <div class="container-fluid">
        ...
        if (isset($_SESSION['ERRO']['SENHA'])) {
            echo '<div class="ls-alert-danger ls-dismissable"> <span data-ls-module="dismiss" class="ls-dismiss">&times;</span>' . $_SESSION['ERRO']['SENHA'] . '</div>';
        ...
        <div class="botao-direita"> 
            <form action="<?php echo ROOT ?>os/finalizada/finalizada_search" method="POST" class="ls-form ls-form-inline row">
                <label class="ls-label col-md-9">
                    <b class="ls-label-text">Filtrar</b>
                    <input type="text" name="palavra_filtro_finalizada" placeholder="OS, cliente, equipamento, extencionista" title="Número OS, Modelo e Defeito" required > <!-- alterar esse nome-->
                </label>
        ...
        <h1 class="ls-title-intro">Lista de OS Finalizadas</h1>
